<template>
  <el-dialog title="new" :visible.sync="dialogFormVisible" width="30%" :append-to-body="true">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click="dialogFormVisible = false">return</el-button>
      <el-button type="primary" @click="addEmployee('formData')">ok</el-button>
    </div>
  </el-dialog>
</template>
      ...
      return {
        ...
        rules:{
          ...
          phone:[
            ...
            {pattern: /^[1][3456789][0-9]{9}$/, message: 'please enter true phone' }
          ],
          address:[
            {required: true,validator: checkrelus, trigger: 'blur'},
          ]
