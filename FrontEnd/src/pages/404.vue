...
<div class="error-panel animated fadeInUp">
  ...
  <div class="error-ctrl">
    <m-button type="info" @click="$router.push({name: 'home'})" round><i class="fa fa-home"></i>&nbsp;to login </m-button>
    <m-button @click="$router.back()" round plain><i class="fa fa-arrow-left"></i>&nbsp;cancel</m-button>
  </div>
