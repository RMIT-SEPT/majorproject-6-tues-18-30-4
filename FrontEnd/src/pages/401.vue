...
<div class="error-panel animated fadeInUp">
  ...
  <div class="error-ctrl">
    <el-button type="info" @click="$router.push({name: 'login'})" round><i class="fa fa-home"></i>&nbsp; to login </el-button>
    <el-button @click="$router.back()" round plain><i class="fa fa-arrow-left"></i>&nbsp;cancel</el-button>
  </div>
