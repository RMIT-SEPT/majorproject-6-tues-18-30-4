  ...
  <el-dialog title="新增菜单" :visible.sync="dialogFormVisible" :append-to-body="true">
    <el-form :model="form" ref="form" :rules="rules" status-icon>
      <el-form-item label="上级菜单" :label-width="formLabelWidth">
        <el-select v-model="form.parentId" clearable placeholder="请选择" @focus="loadData()">
          <el-option
      ...
      <el-form-item label="sort" :label-width="formLabelWidth">
        <el-input-number v-model="rowLength" :min="1" :max="100" label="sort"></el-input-number>
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="addMenu('form')">ok</el-button>
    </div>
  </el-dialog>
</template>
